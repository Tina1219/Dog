			...
			<div class="navbar">
				<div class="container">
					...
					<ul class="nav js-onePageNav">
						...
						<li class="nav-item">
							<a href="index.html#reservation" class="nav-link">預約</a>
						</li>
						<li class="nav-item">
							<a href="index.html#menu" class="nav-link">狗狗</a>
						</li>
						<li class="nav-item">
			...
			<div class="jumbotron jumbotron-video">
				...
				<div class="container">
					...
					<div class="btn-group-center js-fadeInUp">
						<a href="#!" class="btn btn-lg btn-primary">認識我們</a>
						<a href="#!" class="btn btn-lg btn-secondary">歡迎光臨</a>
					</div>
				</div>
			</div>
			<!-- End jumbotron -->
					...
					<div class="row">
						<div class="col-lg-6 col-md-12">
							<div class="about-preview js-fadeInLeft">
								<h3 class="title">每一次搖尾巴，都是最真誠的愛
								</h3>
								<p class="para">牠不在乎你的成就,也不計較你的心情好壞,只會在你回家時熱情迎接。每一隻狗狗都用最純粹的陪伴,讓平凡的日子充滿幸福與溫暖。</p>
								<a href="#!" class="btn btn-primary">認識更多毛孩的故事</a>
							</div>
						</div>
						<div class="col-lg-6 col-md-12">
			...
			<div id="service" class="hero hero-bg-white">
				...
				<div class="container">
					<div class="section-intro js-fadeInUp">
						...
						<p class="para">無論是日常照護、互動陪伴,還是分享毛孩故
						事,我們都希望讓每一隻狗狗感受到溫暖與關
					    愛,也陪伴每位飼主留下珍貴回憶。</p>
					</div>
						...
						<div class="row">
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="service-item js-fadeInUp">
									...
									<div class="preview">
										<h4 class="title">陪伴每一天</h4>
										<h5 class="subtitle">用心守護·真誠陪伴</h5>
										<p class="para">每天的散步、玩耍與互動,都是狗狗最期待的時光。透過耐心陪伴,建立彼此最深厚的信任與情感。
										</p>
							...
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="service-item">
									...
									<div class="preview">
										<h4 class="title">快樂探索</h4>
										<h5 class="subtitle">自由奔跑·盡情玩樂</h5>
										<p class="para">在安全舒適的環境中探索世界,
										享受陽光、草地與新鮮空氣,讓每一次冒險都充滿歡
										笑與活力。
									</p>
										<a href="#!" class="btn btn-secondary">Read more</a>
									</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="service-item">
									...
									<div class="preview">
										<h4 class="title">溫暖相伴</h4>
										<h5 class="subtitle">忠誠守護·幸福同行
										</h5>
										<p class="para">狗狗用最純真的眼神與最真誠
										的陪伴,讓平凡的生活充滿療癒與感動,成為家人最
									重要的一份子。
								</p>
										<a href="#!" class="btn btn-secondary">Read more</a>
									</div>
			...
			<div id="reservation" class="hero reservation">
				...
				<div class="container">
					<div class="section-intro js-fadeInUp">
						...
						<p class="para">想來陪陪牠嗎？趕快為你的午後時光找個好去處</p>
					</div>
					<div class="btn-group-center js-fadeInUp">
						<a href="#!" class="btn btn-primary btn-lg">預約</a>
					</div>
				</div>
			</div>
			<!-- End reservation -->
			...
			<div id="menu" class="hero">
				...
				<div class="container">
					<div class="section-intro js-fadeInUp">
						...
						<p class="para">來看看我們的狗狗，每一隻都獨一無二<br></p>
					</div>
					<div class="menu-list js-fadeInUp">
						...
						<div class="owl-carousel owl-theme">
							<a class="list-item" data-fancybox="group" href="assets/images/products/product005.jpg">
								...
								<div class="preview">
									<h5 class="title">黃金獵犬</h5>
									<h6 class="subtitle">溫暖小太陽,最貼心的療癒小天使</h6>
								</div>
							</a>
							<a class="list-item" data-fancybox="group" href="assets/images/products/product006.jpg">
								...
								<div class="preview">
									<h5 class="title">拉不拉多</h5>
									<h6 class="subtitle">聰慧、沉穩又愛撒嬌,像熱可可一樣踏實溫暖</h6>
								</div>
							</a>
							<a class="list-item" data-fancybox="group" href="assets/images/products/product007.jpg">
								...
								<div class="preview">
									<h5 class="title">哈士奇</h5>
									<h6 class="subtitle">外表英挺帥氣,骨子裡充滿好奇心的調皮鬼</h6>
								</div>
							</a>
							<a class="list-item" data-fancybox="group" href="assets/images/products/product008.jpg">
								...
								<div class="preview">
									<h5 class="title">澳洲牧羊犬</h5>
									<h6 class="subtitle">神秘藍眼睛搭配藝術感斑紋,機靈又迷人的獨特焦點</h6>
								</div>
							</a>
					...
					<div class="row">
						<div class="col-lg-6 col-md-12">
							<div class="contact-info js-fadeInLeft">
								...
								<div class="info-item">
									...
									<a href="#!" class="info">235新北市中和區仁和里中正路641號1樓</a>
								</div>
								<div class="info-item">
									<h4 class="title"><span>HOURS</span></h4>
									<a href="#!" class="info">上午 11:00 至下午 9:30
									</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-12">
							<div class="map-container js-fadeInRight">
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14464.516496655082!2d121.46597358715819!3d24.995728!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3442a948fc79b5f9%3A0xdb723fb9dfc601e0!2z55CD55CD5bm854qs5a-154mp5bqX!5e0!3m2!1szh-TW!2stw!4v1782287280739!5m2!1szh-TW!2stw" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
							</div>
						</div>
					</div>
				</div>	
